...
def save_html_file(folder_name, keyword, html_content):
    ...
    print(f"File {keyword} saved to {folder_name} folder")

def save_xml_file(folder_name, keyword, xml_content):
    with open(f'{folder_name}/{keyword}.xml', mode = 'w', encoding='utf-8') as file:
